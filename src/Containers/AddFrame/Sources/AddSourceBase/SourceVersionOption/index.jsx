/*
 * @Author: 六记
 * @Date: 2022-04-18 17:59:25
 * @LastEditTime: 2022-04-19 14:17:19
 * @LastEditors: your name
 * @Description:
 * @FilePath: \aplicationserver\src\Containers\AddFrame\Sources\AddSourceBase\SourceVersionOption\index.jsx
...
function SourceVersionOption(props) {
    ...
    const checkGetFunction = async () => {
        let {
            ...
            versionRequestsHttpExtractFlags,
        } = getVersionInFrom();

        if (versionRequestsHttpType === "get") {
        ...
        } else if (versionRequestsHttpType === "post") {
            // const data = await axios.get(versionRequestsHttp, {headers:requestsHttpHeader||""})
    ...
    return (
        <>
            ...
            <Form.Item
                name="versionRequestsHttpType"
                label={"请求方式"}
                tooltip={"以什么请求方式对存在版本信息的网站链接进行访问"}
            >
            ...
            <Form.Item
                name="versionRequestsHttpExtractType"
                label={"提取方法类型"}
            ...
            <Form.Item label={"提取值"} tooltip={"获取版本信息的提取值"}>
                <Form.Item
...
export default SourceVersionOption;
